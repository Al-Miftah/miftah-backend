...
"data": {
    ...
    <div class="container-fluid" id="update">
        <h3>Update a speech</h3>
        <h4>
            Endpoint: <code>/speeches/:id</code>
        </h4>
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
...
"data": {
        ...
        "title": "John",
        "summary": "Doe",
        "transcription": "Lorem ipsum text here",
        "url": "https://storage.firebase.com/recording.mp3",
    ...
    <div class="container-fluid" id="view">
        <h3>View profile details of a speech</h3>
        <h4>
            Endpoint: <code>/speeches/:id</code>
        </h4>
        <div class="row">
