$(document).ready(function() {
	...
	const resource = location.search.substr(1).split('&')[0].split('=')[1]
	if (resource) {
		var current = $("a[href='#" + resource + "']")
		var lastScrolledPosition = current.offset().top - 160 //608
		$('.sidebar-scroll').slimScroll({ 
				scrollTo: lastScrolledPosition 
			});
		if (current.length) {
